...
public class CommandeResourceIT {
    ...
    @Test
    @Transactional
    public void checkTypeserviceIsRequired() throws Exception {
        int databaseSizeBeforeTest = commandeRepository.findAll().size();
        // set the field null
        commande.setTypeservice(null);
    ...
    @Test
    @Transactional
    public void getAllCommandesByVehiculeIsEqualToSomething() throws Exception {
        // Initialize the database
        commandeRepository.saveAndFlush(commande);
        ...
        // Get all the commandeList where vehicule equals to vehiculeId
        defaultCommandeShouldBeFound("vehiculeId.equals=" + vehiculeId);

        // Get all the commandeList where vehicule equals to vehiculeId + 1
        defaultCommandeShouldNotBeFound("vehiculeId.equals=" + (vehiculeId + 1));
    }
