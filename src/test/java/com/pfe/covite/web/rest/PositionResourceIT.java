...
public class PositionResourceIT {
    ...
    @Test
    @Transactional
    public void checkPointdepartIsRequired() throws Exception {
        int databaseSizeBeforeTest = positionRepository.findAll().size();
        // set the field null
        position.setPointdepart(null);
    ...
    @Test
    @Transactional
    public void checkPointarriveIsRequired() throws Exception {
        int databaseSizeBeforeTest = positionRepository.findAll().size();
        // set the field null
        position.setPointarrive(null);
